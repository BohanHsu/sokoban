...
def gameHeuristic4(gameboard):
    """
    find the max-distance for all boxes to the nearest goals
    The max distance version of heuristic 1
    """
    boxes = set(gameboard.boxes)
    goals = list(gameboard.goals)
    total_distance = 0
...
def gameHeuristic5(gameboard):
    """
    find the max-distance for all boxes to the nearest goals
    The max distance version of heuristic 2
    """
    boxes = set(gameboard.boxes)
    goals = list(gameboard.goals)
    robot = gameboard.robot
...
def gameHeuristic6(gameboard):
    """
    find the min-distance for all boxes to the nearest goals
    The max distance version of heuristic 3
    """
    boxes = set(gameboard.boxes)
    goals = list(gameboard.goals)
    robot = gameboard.robot
